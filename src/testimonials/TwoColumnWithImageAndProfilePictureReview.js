...
import consequence2 from "../images/consequeence2.jpg"
...
const QuoteContainer = tw.div`relative mt-2 lg:mt-20`;
...
const TwoColumnWithImageAndProfilePictureReview= ({
  subheading = "",
  heading = "les conséquences ",
  description = "Les risques psychosociaux (RPS) ont non seulement un impact sur la santé des infirmiers (ères) mais également sur les collectifs de travail et sur la qualité du travail rendu.",
  testimonials = null,
  textOnLeft = false
}) => {
  /*
